  ...
  <div className="col-sm-4">
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">Risk Investigation For Insurance Industry</h5>
        <p className="card-text">Profile verification is a critical service that Ample Secure provides to its insurance
industry clients.</p>
       <Link to={"/Risk"} className="btn btn-primary">Read More</Link>
  ...
  <div className="col-sm-4">
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">Employment Verification in Corporates</h5>
        <p className="card-text">employment verification is a process in which an employer verifies the employment
history of a job candidate or an existing employee.</p>
        <Link to={"/Employment"} className="btn btn-primary">Read More</Link>
        {/* <a href="#" className="btn btn-primary">Go somewhere</a> */}
      </div>
    </div>
  </div>
  <div className="col-sm-4">
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">Private Investigations Industry</h5>
        <p className="card-text">private investigation services typically involve conducting investigations for individuals,
businesses, or organizations.</p>
        <Link to={"/Private"} className="btn btn-primary">Read More</Link>
        {/* <a href="#" className="btn btn-primary">Go somewhere</a> */}
      </div>
    </div>
  </div>
